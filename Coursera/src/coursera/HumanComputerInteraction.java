...
public class HumanComputerInteraction {
	...
	public static void main(String[] args) throws IOException {
		String courseName = CourseInfo.humanComputerInteraction;
...
//			Element slide =links.get(0);
//			if(slide.attr("title").equals("Slides")){				
//				System.out.println(slide.attr("href"));
//			}
...
//			System.out.println(mp4.attr("href"));
	...
	public static void createFile(String courseName) throws IOException{
		...
		for (int i=0; i<headers.size();i++) {
			String headerName = headers.get(i).getElementsByTag("h3").text().substring(1);
//			if(headerName.contains(":")){
//				headerName = headerName.replace(":", " -");
//			}
			if(headerName.contains(".")){
				headerName = i+1+headerName.substring(headerName.lastIndexOf("."));
